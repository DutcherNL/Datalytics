A low humidity has been detected for extended duration. Ideally, humidity remains above 40%. However between {{ dt_start }} and {{ dt_last_update }} an average humidity of {{ avg_value }}% has been detected.
